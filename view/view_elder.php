        ...
        <table>
            ...
            <tbody>
                <?php foreach ($elders as $elder): ?>
                    <?php  $assined_nurse = getAssignedNurse($elder['elder_ID']); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="../control/assign_nurse_control.php" method="post">
                                ...
                                <option value=""><?= htmlspecialchars(!empty($assined_nurse['Nurse_name']) ? $assined_nurse['Nurse_name'] : 'Select Nurse') ?></option>
